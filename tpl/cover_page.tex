...
\vspace{1.5mm}
\textbf{{Higher Institution of Computer Science}}
\end{minipage}
\hfill
...
\begin{center}
{\LARGE{\textbf{\textsc{END OF COURSE INTERNSHIP REPORT}}}}\\
\vskip0.5cm
\large
...
\begin{figure}[h]
\centering
{\color{isiBlue}{\fboxrule=2.5pt\fbox{\includegraphics[width=0.4\columnwidth]{Logo_Entreprise}}}}
\end{figure}
\end{center}
